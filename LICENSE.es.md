...
1. Cada usuario tiene cuatro libertades fundamentales de las que puede disfrutar indefinidamente en todo el mundo:
    ...
    1. La libertad de estudiar cómo funciona la obra y modificarla según sus propias necesidades.  
       El acceso a la forma fuente de la obra es una condición previa para esta libertad.

    2. La libertad de distribuir copias, para que el usuario pueda, por ejemplo, ayudar a su vecino.
...
4. Las obras derivadas deben indicar claramente si están o no relacionadas con el autor original,  
   incluyendo, entre otras cosas, la mención del nombre del autor original y cualquier posible cambio de nombre o marca.

5. La obra se proporciona _tal cual_, sin ninguna garantía expresa ni implícita.  
   El usuario utiliza la obra bajo su propio riesgo.

---

Copyleft 2025 rev. Damjes

Este texto en sí mismo es libre y puede distribuirse bajo las mismas condiciones.
